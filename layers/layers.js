...
var format_Box_Get_Valve_7 = new ol.format.GeoJSON();
var features_Box_Get_Valve_7 = format_Box_Get_Valve_7.readFeatures(json_Box_Get_Valve_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Box_Get_Valve_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Box_Get_Valve_7.addFeatures(features_Box_Get_Valve_7);
var lyr_Box_Get_Valve_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Box_Get_Valve_7, 
                style: style_Box_Get_Valve_7,
                popuplayertitle: 'Box_Get_Valve',
                interactive: true,
                title: '<img src="styles/legend/Box_Get_Valve_7.png" /> Box_Get_Valve'
            });
var format_Box_Alva_Valev_8 = new ol.format.GeoJSON();
var features_Box_Alva_Valev_8 = format_Box_Alva_Valev_8.readFeatures(json_Box_Alva_Valev_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Box_Alva_Valev_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Box_Alva_Valev_8.addFeatures(features_Box_Alva_Valev_8);
var lyr_Box_Alva_Valev_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Box_Alva_Valev_8, 
                style: style_Box_Alva_Valev_8,
                popuplayertitle: 'Box_Alva_Valev',
                interactive: true,
                title: '<img src="styles/legend/Box_Alva_Valev_8.png" /> Box_Alva_Valev'
            });
var format_BangunanAir_9 = new ol.format.GeoJSON();
var features_BangunanAir_9 = format_BangunanAir_9.readFeatures(json_BangunanAir_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BangunanAir_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BangunanAir_9.addFeatures(features_BangunanAir_9);
var lyr_BangunanAir_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BangunanAir_9, 
                style: style_BangunanAir_9,
                popuplayertitle: 'Bangunan Air',
                interactive: true,
                title: '<img src="styles/legend/BangunanAir_9.png" /> Bangunan Air'
            });
...
var group_TITIKAKSESORIS = new ol.layer.Group({
                                layers: [lyr_Box_Get_Valve_7,lyr_Box_Alva_Valev_8,lyr_BangunanAir_9,lyr_Bangunan_Bagi_10,lyr_Rumah_Pompa_11,],
                                fold: 'open',
                                title: 'TITIK AKSESORIS'});

lyr_GoogleSatellite_0.setVisible(true);lyr_SUNGAI_1.setVisible(true);lyr_JALAN_2.setVisible(true);lyr_AREAFUNGSIONAL_3.setVisible(true);lyr_JalurPipa_4.setVisible(true);lyr_KETERANGAN_KERUSAKAN_SALURAN_5.setVisible(true);lyr_Jenis_Saluran_6.setVisible(true);lyr_Box_Get_Valve_7.setVisible(true);lyr_Box_Alva_Valev_8.setVisible(true);lyr_BangunanAir_9.setVisible(true);lyr_Bangunan_Bagi_10.setVisible(true);lyr_Rumah_Pompa_11.setVisible(true);lyr_Tikungan_12.setVisible(true);lyr_Beda_Pasangan_13.setVisible(true);lyr_Gorong__Gorong_14.setVisible(true);lyr_Titik_Per_50_15.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_SUNGAI_1,lyr_JALAN_2,lyr_AREAFUNGSIONAL_3,lyr_JalurPipa_4,lyr_KETERANGAN_KERUSAKAN_SALURAN_5,lyr_Jenis_Saluran_6,group_TITIKAKSESORIS,group_TITIKKETERANGAN];
...
lyr_Box_Get_Valve_7.set('fieldAliases', {'NAME': 'NAME', 'Descriptio': 'Descriptio', 'pdfmaps_ph': 'pdfmaps_ph', 'Photo_Name': 'Photo_Name', 'X': 'X', 'Y': 'Y', 'Bujur': 'Bujur', 'Lintang': 'Lintang', 'Panjang': 'Panjang', 'Foto_1': 'Foto_1', 'Foto_2': 'Foto_2', 'Foto_3': 'Foto_3', 'Foto_4': 'Foto_4', 'Foto_5': 'Foto_5', 'Foto_6': 'Foto_6', 'Foto_7': 'Foto_7', 'Foto_8': 'Foto_8', });
lyr_Box_Alva_Valev_8.set('fieldAliases', {'NAME': 'NAME', 'Descriptio': 'Descriptio', 'pdfmaps_ph': 'pdfmaps_ph', 'Photo_Name': 'Photo_Name', 'X': 'X', 'Y': 'Y', 'Bujur': 'Bujur', 'Lintang': 'Lintang', 'Panjang': 'Panjang', 'Foto_1': 'Foto_1', 'Foto_2': 'Foto_2', 'Foto_3': 'Foto_3', 'Foto_4': 'Foto_4', 'Foto_5': 'Foto_5', 'Foto_6': 'Foto_6', 'Foto_7': 'Foto_7', 'Foto_8': 'Foto_8', });
lyr_BangunanAir_9.set('fieldAliases', {'NAME': 'NAME', 'Descriptio': 'Descriptio', 'pdfmaps_ph': 'pdfmaps_ph', 'Photo_Name': 'Photo_Name', 'X': 'X', 'Y': 'Y', 'Bujur': 'Bujur', 'Lintang': 'Lintang', 'Panjang': 'Panjang', 'Foto_1': 'Foto_1', 'Foto_2': 'Foto_2', 'Foto_3': 'Foto_3', 'Foto_4': 'Foto_4', 'Foto_5': 'Foto_5', 'Foto_6': 'Foto_6', 'Foto_7': 'Foto_7', 'Foto_8': 'Foto_8', });
lyr_Bangunan_Bagi_10.set('fieldAliases', {'NAME': 'NAME', 'Descriptio': 'Descriptio', 'pdfmaps_ph': 'pdfmaps_ph', 'Photo_Name': 'Photo_Name', 'X': 'X', 'Y': 'Y', 'Bujur': 'Bujur', 'Lintang': 'Lintang', 'Panjang': 'Panjang', 'Foto_1': 'Foto_1', 'Foto_2': 'Foto_2', 'Foto_3': 'Foto_3', 'Foto_4': 'Foto_4', 'Foto_5': 'Foto_5', 'Foto_6': 'Foto_6', 'Foto_7': 'Foto_7', 'Foto_8': 'Foto_8', });
lyr_Rumah_Pompa_11.set('fieldAliases', {'NAME': 'NAME', 'Descriptio': 'Descriptio', 'pdfmaps_ph': 'pdfmaps_ph', 'Photo_Name': 'Photo_Name', 'X': 'X', 'Y': 'Y', 'Bujur': 'Bujur', 'Lintang': 'Lintang', 'Panjang': 'Panjang', 'Foto_1': 'Foto_1', 'Foto_2': 'Foto_2', 'Foto_3': 'Foto_3', 'Foto_4': 'Foto_4', 'Foto_5': 'Foto_5', 'Foto_6': 'Foto_6', 'Foto_7': 'Foto_7', 'Foto_8': 'Foto_8', });
...
lyr_KETERANGAN_KERUSAKAN_SALURAN_5.set('fieldImages', {'Id': 'Range', 'JENIS': 'TextEdit', 'KATEGORI': 'TextEdit', 'KETERANGAN': 'TextEdit', 'PANJANG': 'TextEdit', });
lyr_Jenis_Saluran_6.set('fieldImages', {'Id': 'Range', 'JENIS': 'TextEdit', 'KATEGORI': 'TextEdit', 'KETERANGAN': 'TextEdit', 'PANJANG': 'TextEdit', });
lyr_Box_Get_Valve_7.set('fieldImages', {'NAME': 'TextEdit', 'Descriptio': 'TextEdit', 'pdfmaps_ph': 'TextEdit', 'Photo_Name': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'Bujur': 'TextEdit', 'Lintang': 'TextEdit', 'Panjang': 'TextEdit', 'Foto_1': 'ExternalResource', 'Foto_2': 'ExternalResource', 'Foto_3': 'ExternalResource', 'Foto_4': 'ExternalResource', 'Foto_5': 'ExternalResource', 'Foto_6': 'TextEdit', 'Foto_7': 'TextEdit', 'Foto_8': 'TextEdit', });
lyr_Box_Alva_Valev_8.set('fieldImages', {'NAME': 'TextEdit', 'Descriptio': 'TextEdit', 'pdfmaps_ph': 'TextEdit', 'Photo_Name': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'Bujur': 'TextEdit', 'Lintang': 'TextEdit', 'Panjang': 'TextEdit', 'Foto_1': 'ExternalResource', 'Foto_2': 'ExternalResource', 'Foto_3': 'ExternalResource', 'Foto_4': 'ExternalResource', 'Foto_5': 'ExternalResource', 'Foto_6': 'TextEdit', 'Foto_7': 'TextEdit', 'Foto_8': 'TextEdit', });
lyr_BangunanAir_9.set('fieldImages', {'NAME': 'TextEdit', 'Descriptio': 'TextEdit', 'pdfmaps_ph': 'TextEdit', 'Photo_Name': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'Bujur': 'TextEdit', 'Lintang': 'TextEdit', 'Panjang': 'TextEdit', 'Foto_1': 'ExternalResource', 'Foto_2': 'ExternalResource', 'Foto_3': 'ExternalResource', 'Foto_4': 'ExternalResource', 'Foto_5': 'TextEdit', 'Foto_6': 'TextEdit', 'Foto_7': 'TextEdit', 'Foto_8': 'TextEdit', });
lyr_Bangunan_Bagi_10.set('fieldImages', {'NAME': 'TextEdit', 'Descriptio': 'TextEdit', 'pdfmaps_ph': 'TextEdit', 'Photo_Name': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'Bujur': 'TextEdit', 'Lintang': 'TextEdit', 'Panjang': 'TextEdit', 'Foto_1': 'ExternalResource', 'Foto_2': 'ExternalResource', 'Foto_3': 'ExternalResource', 'Foto_4': 'ExternalResource', 'Foto_5': 'ExternalResource', 'Foto_6': 'TextEdit', 'Foto_7': 'TextEdit', 'Foto_8': 'TextEdit', });
lyr_Rumah_Pompa_11.set('fieldImages', {'NAME': 'TextEdit', 'Descriptio': 'TextEdit', 'pdfmaps_ph': 'TextEdit', 'Photo_Name': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'Bujur': 'TextEdit', 'Lintang': 'TextEdit', 'Panjang': 'TextEdit', 'Foto_1': 'ExternalResource', 'Foto_2': 'ExternalResource', 'Foto_3': 'ExternalResource', 'Foto_4': 'ExternalResource', 'Foto_5': 'ExternalResource', 'Foto_6': 'TextEdit', 'Foto_7': 'TextEdit', 'Foto_8': 'TextEdit', });
...
lyr_Beda_Pasangan_13.set('fieldImages', {'NAME': 'TextEdit', 'Descriptio': 'TextEdit', 'pdfmaps_ph': 'TextEdit', 'Photo_Name': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'Bujur': 'TextEdit', 'Lintang': 'TextEdit', 'Panjang': 'TextEdit', 'Foto_1': 'ExternalResource', 'Foto_2': 'ExternalResource', 'Foto_3': 'ExternalResource', 'Foto_4': 'ExternalResource', 'Foto_5': 'TextEdit', 'Foto_6': 'TextEdit', 'Foto_7': 'TextEdit', 'Foto_8': 'TextEdit', });
...
lyr_KETERANGAN_KERUSAKAN_SALURAN_5.set('fieldLabels', {'Id': 'hidden field', 'JENIS': 'hidden field', 'KATEGORI': 'inline label - visible with data', 'KETERANGAN': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', });
...
lyr_Box_Get_Valve_7.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Descriptio': 'hidden field', 'pdfmaps_ph': 'hidden field', 'Photo_Name': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'Bujur': 'inline label - visible with data', 'Lintang': 'inline label - visible with data', 'Panjang': 'inline label - visible with data', 'Foto_1': 'no label', 'Foto_2': 'no label', 'Foto_3': 'no label', 'Foto_4': 'no label', 'Foto_5': 'no label', 'Foto_6': 'no label', 'Foto_7': 'no label', 'Foto_8': 'no label', });
...
lyr_BangunanAir_9.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Descriptio': 'hidden field', 'pdfmaps_ph': 'hidden field', 'Photo_Name': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'Bujur': 'inline label - visible with data', 'Lintang': 'inline label - visible with data', 'Panjang': 'inline label - visible with data', 'Foto_1': 'no label', 'Foto_2': 'no label', 'Foto_3': 'no label', 'Foto_4': 'no label', 'Foto_5': 'no label', 'Foto_6': 'no label', 'Foto_7': 'no label', 'Foto_8': 'no label', });
lyr_Bangunan_Bagi_10.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Descriptio': 'hidden field', 'pdfmaps_ph': 'hidden field', 'Photo_Name': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'Bujur': 'inline label - visible with data', 'Lintang': 'inline label - visible with data', 'Panjang': 'inline label - visible with data', 'Foto_1': 'no label', 'Foto_2': 'no label', 'Foto_3': 'no label', 'Foto_4': 'no label', 'Foto_5': 'no label', 'Foto_6': 'no label', 'Foto_7': 'no label', 'Foto_8': 'no label', });
lyr_Rumah_Pompa_11.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Descriptio': 'hidden field', 'pdfmaps_ph': 'hidden field', 'Photo_Name': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'Bujur': 'inline label - visible with data', 'Lintang': 'inline label - visible with data', 'Panjang': 'inline label - visible with data', 'Foto_1': 'no label', 'Foto_2': 'no label', 'Foto_3': 'no label', 'Foto_4': 'no label', 'Foto_5': 'no label', 'Foto_6': 'no label', 'Foto_7': 'no label', 'Foto_8': 'no label', });
...
lyr_Titik_Per_50_15.on('precompose', function(evt) {
